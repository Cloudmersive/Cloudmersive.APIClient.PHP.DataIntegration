...
& java -jar swagger-codegen-cli.jar generate -i https://api.cloudmersive.com/swagger/api/dataintegration -l php -c packageconfig.json
#(Get-Content ./client/package.json).replace('v1', '1.0.1') | Set-Content ./client/package.json
Copy-Item ./cloudmersive_dataintegration_api_client/* -Destination . -Recurse -Force
...
(Get-Content ./README.md).replace('This PHP package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', '[Cloudmersive Data Integration API](https://cloudmersive.com/data-integration-api) - Easily and directly query database backup files, convert into other file formats.') | Set-Content ./README.md
